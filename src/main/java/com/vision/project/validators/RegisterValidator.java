package com.vision.project.validators;
...
public class RegisterValidator implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "username", String.format("Username must be between %d and %d", MINIMUM_NAME_LENGTH, MAXIMUM_NAME_LENGTH));
